...
public class Game1 : Game
{
    ...
    protected override void Initialize()
    {
        ...
        _player = new Player(_grid, _camera, new Vector2(5, 5), 10, isIsometricView);
        _enemies = new List<Enemy>
        {
            new Enemy(new Vector2(10, 10), _player, _grid, 10, isIsometricView),
            new Enemy(new Vector2(15, 8), _player, _grid, 10, isIsometricView)
        };
